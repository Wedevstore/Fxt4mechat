...
class WhatsappWebRepository
{
    ...
    private function handleIncomingMessage($value, $contact_id, $name, $message_id, $client, $message_type, $file_url, $token)
    {
        try {
            ...
            $this->saveIncommingMessage($contact, $content, $client, $is_contact_msg, $is_campaign_msg, $type, $message_id, $file_url, $token);
    ...
    private function saveIncommingMessage($contact, $content, $client, $is_contact_msg, $is_campaign_msg, $type, $message_id, $file_url, $token)
    {
        try {
