...
<script>
    ...
    apiKey: "AIzaSyCmDvnQx1e2xevqxu3EiYO8JWFe93PRhhs",
    authDomain: "salebot-4feba.firebaseapp.com",
    projectId: "salebot-4feba",
    storageBucket: "salebot-4feba.appspot.com",
    };
    ...
    firebase.auth().signInWithPopup(provider)
        ...
        result.user.getIdToken().then((idToken) => {
            ...
            console.log(data); // User info or JWT
            });
        });
        })
        .catch((error) => {
