...
Route::group(['prefix' => localeRoutePrefix()], function () {
    Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'verified', 'adminCheck', 'PermissionCheck']], function () {
        ...
        // rapiwa setting
        Route::get('whatsapp-web-setting', [SystemSettingController::class, 'rapiwaSetting'])->name('rapiwa.setting');
        Route::post('whatsapp-web-setting', [SystemSettingController::class, 'saveRapiwaSetting'])->name('rapiwa.setting.store');
